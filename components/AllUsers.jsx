...
<input onChange={(e)=>setSearch(e.target.value)} type="text" name="" id="" placeholder='Search for users'  className='border bg-gray-50  border-gray-300 focus:border-cyan-600 rounded-md text-gray-900 focus:ring-cyan-600 px-2 py-1 '/>
