...
const UserFormAdd = ({ setUserFormAdd }) => {
  const initialValues = {
    firstName: "",
    lastName: "",
    email: "",
  ...
  const onSubmit = (values, { resetForm },) => {
    ...
    console.log(values)
    resetForm();
    setUserFormAdd(false); // Form gönderildikten sonra formu kapat
  };
  ...
  return (
    <div className="bg-white gap-5 w-[40%]  border-2 p-5 absolute top-10 left-[30%] ">
      ...
      <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
        ...
        <div className=" text-center col-span-2 rounded-full ">  <button 
        className="bg-addcolor rounded-full text-white hover:opacity-80 px-3 py-1" type="submit">
            Add user
          </button></div>
        </Form>
      </Formik>
